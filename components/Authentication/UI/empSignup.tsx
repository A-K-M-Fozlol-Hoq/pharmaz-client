...
const EmpSignupUI = (props: IProps) => {
  const {
    setName,
    setEmail,
    setPassword,
  ...
  return (
    <div className="p-10 sm:p-5 w-96 mx-auto my-auto border border-yellow-900 rounded-xl">
      <div className="mb-2 md:mb-3 text-gray-700">
        <h2 className="text-2xl">Create Employee Account</h2>
        <br />
        <div className="mb-2">
